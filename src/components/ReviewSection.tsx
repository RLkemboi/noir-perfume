...
const reviews = [
  {
    ...
    text: "I've worn Tuxedo to every board meeting this year. It commands respect without saying a word. The spiced patchouli is rich, authentic, and lasts well over 12 hours.",
    rating: 5,
    longevity: "14+ hours",
  ...
  },
  {
    name: "Adriana K.",
    product: "Khamrah",
    title: "A masterpiece of warmth.",
    text: "Khamrah is unlike anything else in my collection. It's sweet, intellectual, and incredibly seductive. People stop me in the street to ask what I'm wearing.",
    rating: 5,
    longevity: "12+ hours",
  ...
  {
    name: "James W.",
    product: "Interlude Man",
    title: "Incense royalty.",
    text: "Interlude Man feels like wearing history. The smoke and amber create a scent trail that is simply regal — and the NOIR pour matches the original's presence.",
    rating: 5,
    longevity: "16+ hours",
  ...
  {
    name: "Elena R.",
    product: "Mojave Ghost",
    title: "Freshness redefined.",
    text: "Most airy scents disappear in an hour. Mojave Ghost stays with you. It smells like a desert bloom at dusk — soft, clean, and expensive.",
    rating: 5,
    longevity: "10+ hours",
    compliments: "Daily",
    verified: true,
