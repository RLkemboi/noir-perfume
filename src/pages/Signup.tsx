...
export default function Signup() {
  ...
  const { register, continueAsGuest, signInWithGoogle, signInWithApple } = useAuth();
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="mb-2 inline-block" aria-label="NOIR home">
            <img src="/assets/noir-logo-1.svg" alt="NOIR" className="h-[32rem] w-auto mx-auto" />
          </Link>
        ...
        <div className="glass-panel p-8 space-y-6 luxury-shadow border-primary/10">
          <div className="space-y-3">
            <button
              ...
              disabled={submitting}
              className="w-full py-3 bg-white text-black text-xs tracking-widest uppercase font-bold hover:bg-white/90 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="w-full py-3 bg-black text-white text-xs tracking-widest uppercase font-bold hover:bg-black/80 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
